      ...
      <div className="max-w-5xl mx-auto px-5 py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="https://github.com/TYLDA-Solutions/frostbyte" className="px-5 py-2.5 rounded-md bg-green text-bg font-bold text-sm hover:bg-green/90 transition">
              ★ Star on GitHub
            </a>
     ...
     [ Room: still warm ]`}
        ...
        <section id="quickstart" className="mb-16">
          ...
          <div className="rounded-xl border border-border bg-panel p-5 font-mono text-sm">
            ...
            <div><span className="text-green">$</span> git clone https://github.com/TYLDA-Solutions/frostbyte.git</div>
        ...
        <footer className="border-t border-border pt-8 flex flex-wrap items-center justify-between gap-4 text-sm text-dim">
          ...
          <div className="flex gap-5">
            <a href="https://github.com/TYLDA-Solutions/frostbyte" className="hover:text-green transition">GitHub</a>
